...
ser_model = net.EmotionRegression(1024, args.head_dim, 1, 3, dropout=0.5)
##############################################
...
for epoch in range(EPOCHS):
    ...
    for xy_pair in tqdm(total_dataloader["train"]):
        ...
        writer.add_scalar("Loss/train", torch.sum(loss), iteration)
    ...
    writer.add_scalar("Loss/dev", torch.sum(ccc), epoch)
